...
/**
 * The persistent class for the GSHM_ISOMESSAGE_TMP_200_HTDP database table.
 * 
 */
@Entity
@Table(name="GSHM_ISOMESSAGE_TMP_200_HTDP")
@NamedQuery(name="GshmIsomessageTmp200Htdp.findAll", query="SELECT g FROM GshmIsomessageTmp200Htdp g")
public class GshmIsomessageTmp200Htdp implements Serializable {
	...
	public GshmIsomessageTmp200Htdp() {
	}
