...
/**
 * The persistent class for the GSHM_ISOMESSAGE_TMP_VISA_HTDP database table.
 * 
 */
@Entity
@Table(name="GSHM_ISOMESSAGE_TMP_VISA_HTDP")
@NamedQuery(name="GshmIsomessageTmpVisaHtdp.findAll", query="SELECT g FROM GshmIsomessageTmpVisaHtdp g")
public class GshmIsomessageTmpVisaHtdp implements Serializable {
	...
	public GshmIsomessageTmpVisaHtdp() {
	}
