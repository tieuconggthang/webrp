...
/**
 * The persistent class for the BLOCK_DATA_NHTV_SWITCH_HISTORY database table.
 * 
 */
@Entity
@Table(name="BLOCK_DATA_NHTV_SWITCH_HISTORY")
@NamedQuery(name="BlockDataNhtvSwitchHistory.findAll", query="SELECT b FROM BlockDataNhtvSwitchHistory b")
public class BlockDataNhtvSwitchHistory implements Serializable {
	...
	public BlockDataNhtvSwitchHistory() {
	}
