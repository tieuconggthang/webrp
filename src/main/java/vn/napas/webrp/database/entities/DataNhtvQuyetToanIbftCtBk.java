...
/**
 * The persistent class for the DATA_NHTV_QUYET_TOAN_IBFT_CT_BK database table.
 * 
 */
@Entity
@Table(name="DATA_NHTV_QUYET_TOAN_IBFT_CT_BK")
@NamedQuery(name="DataNhtvQuyetToanIbftCtBk.findAll", query="SELECT d FROM DataNhtvQuyetToanIbftCtBk d")
public class DataNhtvQuyetToanIbftCtBk implements Serializable {
	...
	@Temporal(TemporalType.TIMESTAMP)
	@Column(name="DATE_CREATE_CR")
	private Date dateCreateCr;
	...
	public DataNhtvQuyetToanIbftCtBk() {
	}
	...
	public Date getDateCreateCr() {
		return this.dateCreateCr;
	}

	public void setDateCreateCr(Date dateCreateCr) {
		this.dateCreateCr = dateCreateCr;
	}
