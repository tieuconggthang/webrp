...
/**
 * The persistent class for the GSHM_SHCLOG_GD2 database table.
 * 
 */
@Entity
@Table(name="GSHM_SHCLOG_GD2")
@NamedQuery(name="GshmShclogGd2.findAll", query="SELECT g FROM GshmShclogGd2 g")
public class GshmShclogGd2 implements Serializable {
