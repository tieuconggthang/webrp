...
/**
 * The persistent class for the GSHM_SHCLOG database table.
 * 
 */
@Entity
@Table(name="GSHM_SHCLOG")
@NamedQuery(name="GshmShclog.findAll", query="SELECT g FROM GshmShclog g")
public class GshmShclog implements Serializable {
