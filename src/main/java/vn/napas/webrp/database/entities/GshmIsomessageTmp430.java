...
/**
 * The persistent class for the GSHM_ISOMESSAGE_TMP_430 database table.
 * 
 */
@Entity
@Table(name="GSHM_ISOMESSAGE_TMP_430")
@NamedQuery(name="GshmIsomessageTmp430.findAll", query="SELECT g FROM GshmIsomessageTmp430 g")
public class GshmIsomessageTmp430 implements Serializable {
