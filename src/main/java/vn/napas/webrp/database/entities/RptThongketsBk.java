...
/**
 * The persistent class for the RPT_THONGKETS_BK database table.
 * 
 */
@Entity
@Table(name="RPT_THONGKETS_BK")
@NamedQuery(name="RptThongketsBk.findAll", query="SELECT r FROM RptThongketsBk r")
public class RptThongketsBk implements Serializable {
