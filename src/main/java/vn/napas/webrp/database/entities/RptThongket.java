...
/**
 * The persistent class for the RPT_THONGKETS database table.
 * 
 */
@Entity
@Table(name="RPT_THONGKETS")
@NamedQuery(name="RptThongket.findAll", query="SELECT r FROM RptThongket r")
public class RptThongket implements Serializable {
