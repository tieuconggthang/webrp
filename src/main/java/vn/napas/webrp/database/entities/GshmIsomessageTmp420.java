...
/**
 * The persistent class for the GSHM_ISOMESSAGE_TMP_420 database table.
 * 
 */
@Entity
@Table(name="GSHM_ISOMESSAGE_TMP_420")
@NamedQuery(name="GshmIsomessageTmp420.findAll", query="SELECT g FROM GshmIsomessageTmp420 g")
public class GshmIsomessageTmp420 implements Serializable {
