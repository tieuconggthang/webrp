...
/**
 * The persistent class for the GSHM_ISOMESSAGE_TMP_HTDP database table.
 * 
 */
@Entity
@Table(name="GSHM_ISOMESSAGE_TMP_HTDP")
@NamedQuery(name="GshmIsomessageTmpHtdp.findAll", query="SELECT g FROM GshmIsomessageTmpHtdp g")
public class GshmIsomessageTmpHtdp implements Serializable {
