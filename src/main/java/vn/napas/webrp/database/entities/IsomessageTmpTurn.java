...
/**
 * The persistent class for the ISOMESSAGE_TMP_TURN database table.
 * 
 */
@Entity
@Table(name="ISOMESSAGE_TMP_TURN")
@NamedQuery(name="IsomessageTmpTurn.findAll", query="SELECT i FROM IsomessageTmpTurn i")
public class IsomessageTmpTurn implements Serializable {
