...
/**
 * The persistent class for the GSHM_SHCLOG_HTDP database table.
 * 
 */
@Entity
@Table(name="GSHM_SHCLOG_HTDP")
@NamedQuery(name="GshmShclogHtdp.findAll", query="SELECT g FROM GshmShclogHtdp g")
public class GshmShclogHtdp implements Serializable {
