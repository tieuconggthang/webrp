...
/**
 * The persistent class for the GDTSCANCEL database table.
 * 
 */
@Entity
@NamedQuery(name="Gdtscancel.findAll", query="SELECT g FROM Gdtscancel g")
public class Gdtscancel implements Serializable {
