...
/**
 * The persistent class for the TSOL_MNGR_MENU_TRY database table.
 * 
 */
@Entity
@Table(name="TSOL_MNGR_MENU_TRY")
@NamedQuery(name="TsolMngrMenuTry.findAll", query="SELECT t FROM TsolMngrMenuTry t")
public class TsolMngrMenuTry implements Serializable {
