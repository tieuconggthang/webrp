...
/**
 * The persistent class for the GSHM_IST_TMP_HTDP database table.
 * 
 */
@Entity
@Table(name="GSHM_IST_TMP_HTDP")
@NamedQuery(name="GshmIstTmpHtdp.findAll", query="SELECT g FROM GshmIstTmpHtdp g")
public class GshmIstTmpHtdp implements Serializable {
