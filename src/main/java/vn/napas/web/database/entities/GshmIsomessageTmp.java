...
/**
 * The persistent class for the GSHM_ISOMESSAGE_TMP database table.
 * 
 */
@Entity
@Table(name="GSHM_ISOMESSAGE_TMP")
@NamedQuery(name="GshmIsomessageTmp.findAll", query="SELECT g FROM GshmIsomessageTmp g")
public class GshmIsomessageTmp implements Serializable {
