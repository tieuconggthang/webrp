...
/**
 * The persistent class for the GSHM_ISOMESSAGE_TMP_200 database table.
 * 
 */
@Entity
@Table(name="GSHM_ISOMESSAGE_TMP_200")
@NamedQuery(name="GshmIsomessageTmp200.findAll", query="SELECT g FROM GshmIsomessageTmp200 g")
public class GshmIsomessageTmp200 implements Serializable {
