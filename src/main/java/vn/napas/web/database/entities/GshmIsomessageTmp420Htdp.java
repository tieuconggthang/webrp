...
/**
 * The persistent class for the GSHM_ISOMESSAGE_TMP_420_HTDP database table.
 * 
 */
@Entity
@Table(name="GSHM_ISOMESSAGE_TMP_420_HTDP")
@NamedQuery(name="GshmIsomessageTmp420Htdp.findAll", query="SELECT g FROM GshmIsomessageTmp420Htdp g")
public class GshmIsomessageTmp420Htdp implements Serializable {
	...
	public GshmIsomessageTmp420Htdp() {
	}
