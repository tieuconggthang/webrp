...
/**
 * The persistent class for the TSOL_ECOM_NEW database table.
 * 
 */
@Entity
@Table(name="TSOL_ECOM_NEW")
@NamedQuery(name="TsolEcomNew.findAll", query="SELECT t FROM TsolEcomNew t")
public class TsolEcomNew implements Serializable {
	...
	@Column(name="F63_TRANS_SWITCH")
	private String f63TransSwitch;
	...
	public String getF63TransSwitch() {
		return this.f63TransSwitch;
	}

	public void setF63TransSwitch(String f63TransSwitch) {
		this.f63TransSwitch = f63TransSwitch;
	}
