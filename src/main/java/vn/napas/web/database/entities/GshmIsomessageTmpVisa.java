...
/**
 * The persistent class for the GSHM_ISOMESSAGE_TMP_VISA database table.
 * 
 */
@Entity
@Table(name="GSHM_ISOMESSAGE_TMP_VISA")
@NamedQuery(name="GshmIsomessageTmpVisa.findAll", query="SELECT g FROM GshmIsomessageTmpVisa g")
public class GshmIsomessageTmpVisa implements Serializable {
