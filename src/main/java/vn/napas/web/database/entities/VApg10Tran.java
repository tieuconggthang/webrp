...
/**
 * The persistent class for the V_APG10_TRANS database table.
 * 
 */
@Entity
@Table(name="V_APG10_TRANS")
@NamedQuery(name="VApg10Tran.findAll", query="SELECT v FROM VApg10Tran v")
public class VApg10Tran implements Serializable {
	...
	public byte getSettlementCode() {
		return this.settlementCode;
	}

	public void setSettlementCode(byte settlementCode) {
