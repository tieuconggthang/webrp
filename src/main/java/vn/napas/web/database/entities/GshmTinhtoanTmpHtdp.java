...
/**
 * The persistent class for the GSHM_TINHTOAN_TMP_HTDP database table.
 * 
 */
@Entity
@Table(name="GSHM_TINHTOAN_TMP_HTDP")
@NamedQuery(name="GshmTinhtoanTmpHtdp.findAll", query="SELECT g FROM GshmTinhtoanTmpHtdp g")
public class GshmTinhtoanTmpHtdp implements Serializable {
