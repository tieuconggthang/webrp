...
/**
 * The persistent class for the GSHM_ISOMESSAGE_TMP_430_HTDP database table.
 * 
 */
@Entity
@Table(name="GSHM_ISOMESSAGE_TMP_430_HTDP")
@NamedQuery(name="GshmIsomessageTmp430Htdp.findAll", query="SELECT g FROM GshmIsomessageTmp430Htdp g")
public class GshmIsomessageTmp430Htdp implements Serializable {
	...
	public GshmIsomessageTmp430Htdp() {
	}
