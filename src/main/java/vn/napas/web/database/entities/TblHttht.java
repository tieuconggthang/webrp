...
/**
 * The persistent class for the TBL_HTTHT database table.
 * 
 */
@Entity
@Table(name="TBL_HTTHT")
@NamedQuery(name="TblHttht.findAll", query="SELECT t FROM TblHttht t")
public class TblHttht implements Serializable {
