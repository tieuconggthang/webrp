...
/**
 * The persistent class for the GSHM_TINHTOAN_HTDP database table.
 * 
 */
@Entity
@Table(name="GSHM_TINHTOAN_HTDP")
@NamedQuery(name="GshmTinhtoanHtdp.findAll", query="SELECT g FROM GshmTinhtoanHtdp g")
public class GshmTinhtoanHtdp implements Serializable {
